...
import com.yanimetaxas.bookkeeping.TransferRequest.ReferenceStep;
...
public class Ledger extends AbstractAccountingConcept {
  ...
  public Ledger(String name, ChartOfAccounts chartOfAccounts) throws InfrastructureException {
    super("com.yanimetaxas.bookkeeping.BankFactoryImpl", ConnectionOptions.EMBEDDED_H2_CONNECTION);
  ...
  public Ledger(String name, ChartOfAccounts chartOfAccounts, ConnectionOptions options)
    ...
    super("com.yanimetaxas.bookkeeping.BankFactoryImpl", options);
    this.chartOfAccounts = chartOfAccounts;
    this.name = name;
    createAccounts();
  }
